...
public PullResult pullKernelImpl(
        ...
        //todo pullKernelImpl 获取broker信息
        ...
        if (null == findBrokerResult) {
            //todo updateTopicRouteInfoFromNameServer 更新topic信息,再次尝试获取
